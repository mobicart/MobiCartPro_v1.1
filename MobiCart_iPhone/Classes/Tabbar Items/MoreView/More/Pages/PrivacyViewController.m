...
/** The View for displaying privacy information defined for the store **/
...
- (id)initWithNibName:(NSString *)nibNameOrNil bundle:(NSBundle *)nibBundleOrNil
{
    ...
    {
        self.tabBarItem.image=[UIImage imageNamed:@"more_icon_04.png"];
...
- (void)addCartButtonAndLabel
{
    ...
    MobiCartStart *as=[MobiCartStart sharedApplication];
...
- (void)viewWillAppear:(BOOL)animated
{
	...
	[imgViewContactUs setImage:[UIImage imageNamed:@"privacyIcon.png"]];
	...
	[aboutLbl setText:[[GlobalPreferences getLangaugeLabels] valueForKey:@"key.iphone.more.privacy"]];
...
- (void)fetchDataFromServer
{
	...
	arrAllData =(NSArray *)[GlobalPreferences getDictStaticPages];
