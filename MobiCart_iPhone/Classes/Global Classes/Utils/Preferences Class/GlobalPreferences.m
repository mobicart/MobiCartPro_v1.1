...
+(NSArray *)getAllNavigationTitles
{
	...
	NSArray *arrAllData =  (NSArray *)[GlobalPreferences getDictFeatures];
...
#define colorDict dictFeatures
	if (![colorDict isEqual:[NSNull null]])
	{
		if ([colorDict objectForKey:@"sBgColor"])
		{
			UIColor *bgColor = [GlobalPreferences colorWithHexString:[dictFeatures objectForKey:@"sBgColor"]];
		...
		{
			UIColor *bgColor = [GlobalPreferences colorWithHexString:[dictFeatures objectForKey:@"sFgColor"]];
			_savedPreferences.headerColor = bgColor;
		}
        
        if ([colorDict objectForKey:@"sProductItemBgColor"])
		{
			_savedPreferences.subHeaderColor = [dictFeatures objectForKey:@"sProductItemBgColor"];
		}
		if ([colorDict objectForKey:@"sSearchButtonBgColor"])
		{
			UIColor *bgColor = [GlobalPreferences colorWithHexString:[dictFeatures objectForKey:@"sSearchButtonBgColor"]];			_savedPreferences.labelColor = bgColor;
		...
		{
            UIColor *priceBackcolor=[GlobalPreferences colorWithHexString:[dictFeatures objectForKey:@"sPriceTagBgColor"]];			_savedPreferences.priceBackgroundColor = priceBackcolor;
		}
    }
